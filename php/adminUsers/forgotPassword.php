...
<head>
    ...
    <title>Yönetici Şifremi Unuttum</title>
...
<body>
    <div class="login-page-container">
        ...
        <div class="form-content-area">
            <h1 class="welcome-text">Yönetici Şifrenizi Mi Unuttunuz?</h1>
            ...
            <div class="form-box">
                ...
                <form id="forgotPasswordForm" action="../../controller/adminUsers/passwordResetController.php?action=request" method="POST">
                    ...
                    <div style="text-align: center; margin-top: 25px;">
                        <a href="adminUsers.php">Giriş Sayfasına Geri Dön</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="../../js/adminUsers/forgotPassword.js"></script>
</body>
</html>